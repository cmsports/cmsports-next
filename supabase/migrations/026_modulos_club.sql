...
DEFAULT '{torneos,liga,clases,calendario,asistencia,mensualidades,finanzas,elo,redes,tienda}';

-- Clubs existentes quedan con todo habilitado
UPDATE clubes
SET modulos_habilitados = '{torneos,liga,clases,calendario,asistencia,mensualidades,finanzas,elo,redes,tienda}'
